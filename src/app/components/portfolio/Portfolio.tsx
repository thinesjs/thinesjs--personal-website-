...
import valortracker from '../../assets/valortracker.png'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { faCircleInfo, faEye } from '@fortawesome/free-solid-svg-icons'

const PortfolioSection = () => {
    const portfolioItems = [{id: 1, item: valortracker}, {id: 2, item: valortracker}, {id: 3, item: valortracker}]
    return (
                    ...
                    <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0">
                        {portfolioItems.map(({id, item}) => (
                            <div key={id} className="shadow-sm rounded-lg border-[1px]">
                                <Image src={item} alt={'image'} className='rounded-t-lg mx-auto w-fit border-b-[1px] md:w-fit ' />
